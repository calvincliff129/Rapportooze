                        ...
                        @foreach ($lastUpdated as $last_updated)
                            <a href="{{ route('contact.show', $last_updated->id) }}">
                                <div class="card-body img">
                                    ...
                                    @else
                                        <img src="{{ Storage::disk('s3')->temporaryUrl('avatars/'.$last_updated->avatar, now()->addMinutes(60)) }}" class="border bg-primary border-primary" style="width: 78px; height: 78px; float:left; border-radius:35%;">
                                    @endif
                                </div>
                            </a> 
                        @endforeach
