                                ...
                                <td class="d-flex align-items-center" style="border: 0; border-radius: 5rem;">
                                    <a href="{{ route('contact.show', $contact->id) }}">
                                        <div class="img" style="min-width: 70px">
                                            ...
                                            @else
                                                <img src="public/uploads/avatars/{{ $contact->avatar }}" class="border bg-primary border-primary" style="padding: .125rem; width: 55px; height: 55px; float:left; border-radius:35%;">
                                            @endif
                                        </div>
