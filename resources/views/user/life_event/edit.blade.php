                ...
                <div class="card-body mt-2">
                    ...
                    <div class="container">
                        <div class="mb-3 row row-md justify-content-md-center">
                            ...
                            <input type="text" class="form-control{{ $errors->has('happened_at') ? ' is-invalid' : '' }} datepicker-lifeEvent col-md-4" value="@if (!empty( $lifeEvent->happened_at )) {{ date('j F Y', strtotime( $lifeEvent->happened_at )) }} @endif" name="happened_at" id="happened_at" placeholder="When did it happened ?">
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="name">Event name</label>
                        <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ $lifeEvent->name}}" name="name" id="name" placeholder="What's the title of the life event ? . . .">
                    </div>
