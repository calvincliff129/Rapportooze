...
<hr class="dashed">
<div class="container bg-transparent mt-4" style="max-width: 38rem; min-width: 29rem;">
    <div class="card-body">
            ...
            <div class="card-body mt-2">
                <div class="container">
                    <div class="mb-3 row row-md justify-content-md-center">
                        ...
                        <input type="text" class="form-control datepicker-lifeEvent col-md-4" name="happened_at" id="happened_at" placeholder="When did it happened ?">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" id="name" placeholder="What's the title of the life event ? . . .">
                </div>
