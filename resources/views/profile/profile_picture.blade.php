@extends('layouts.user', ['page' => __('Profile'), 'pageSlug' => 'profile'])
        ...
        <div class="col-xl">
            <div class="card text-white">
                <div class="card-body">
                    ...
                    <form enctype="multipart/form-data" action="{{ route('user_avatar.update') }}" method="POST">
                        ...
                        <div class="card bg-dark">
                            ...
                            <div class="card-body row text-center d-flex align-items-center">
                                ...
                                <div class="col-lg mx-auto">
                                    ...
                                    <div>
                                        <a href="{{ route('profile.edit') }}" class="btn btn-default btn-round">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @if ($user->avatar != null)
                        <form action="{{ route('user_avatar.remove') }}" method="POST">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
